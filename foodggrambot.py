...
homework_name = response.get("id")
homework_status = response.get("tags")
homework_author = response.get("author")
homework_ingredients = response.get("ingredients")
homework_is_favorited = response.get("is_favorited")
